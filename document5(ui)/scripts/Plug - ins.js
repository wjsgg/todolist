;(function($){
    ...
    $.fn.dialog = function(options){
        ...
        this.each(function(){
            ...
            _this.click(function(){     
                $("#mask").css("height","100%");   
                $("#mask").css("width","100%");               
                $(".dialog").removeClass("dialogclose").addClass("dialogshow");     
                $(".dialog").css({"position":"fixed","display":"block"});
            })
            $("#btn1").click(function(){
                $("#mask").css("height",0);   
                $("#mask").css("width",0);
                $(".dialog").addClass("dialogclose");
                setTimeout(function () {
    ...
    $.fn.odivnav = function(options){
        ...
        this.each(function(){
            //各种功能  //可以理解成功能代码
            $("#sl1").click(function(){                
                $(".slider ul").removeClass("animateClass").css("margin-left","0px")
            })
            $("#sl2").click(function(){
                $(".slider ul").removeClass("animateClass").css("margin-left","-600px")
            })
            $("#sl3").click(function(){
                $(".slider ul").removeClass("animateClass").css("margin-left","-1200px")
            })
            $("#sl4").click(function(){
                $(".slider ul").removeClass("animateClass").css("margin-left","-1800px")
            })
        });
